document.addEventListener("DOMContentLoaded", function () {
  ...
  const withdrawalForm = withdrawButton?.closest("form");
  ...
  if (!reasonInput || !withdrawButton || !withdrawalForm) return;
  ...
  withdrawalForm.addEventListener("submit", function (event) {
    ...
    isSubmitting = true;
    withdrawButton.disabled = true;
    withdrawButton.textContent = "送信中...";
  });
});
